...
class _ScanResultScreenState extends State<ScanResultScreen> {
  late Future<List<ApprovalData>> _future;
  ...
  void initState() {
    super.initState();
    // Load pre-scanned data directly вЂ” no new scan is triggered here.
    _future = Future.value(widget.initialApprovals);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const TopNav(),
      body: DsBackground(
        child: FutureBuilder<List<ApprovalData>>(
          future: _future,
          builder: (_, snap) {
            ...
            final loc = LocalizationProvider.of(context);
            final approvals = (snap.data ?? <ApprovalData>[]).toList();
            ...
            approvals.sort((a, b) {
              ...
              if (widget.highlightSpender != null &&
                ...
                final bIsHighlight = b.spenderAddress.toLowerCase() ==
                    ...
                    b.token.toLowerCase() ==
                        widget.highlightToken?.toLowerCase();
                if (aIsHighlight != bIsHighlight) return aIsHighlight ? -1 : 1;
              }
                        ...
                        builder: (context) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _badgeColor(v.label).withOpacity(0.1),
                              ),
                            ),
                            child: Column(
                              children: [
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (_, i) {
                                  final a = approvals[i];
                                  final k = _key(a);
                                  final isSelected = _selectedKeys.contains(k);
